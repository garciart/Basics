...
class TestCommonFunctions(unittest.TestCase):
    ...
    def test_validate_user_id_exception(self):
        ...
        """
        arg = "a"
        with self.assertRaises(Exception): co.validate_user_id(arg)
    ...
    def test_validate_text_exception(self):
        ...
        """
        arg = -1
        with self.assertRaises(Exception): co.validate_text(arg)
    ...
    def test_validate_email_exception(self):
        ...
        """
        arg = -1
        with self.assertRaises(Exception): co.validate_email(arg)
    ...
    def test_validate_date_exception(self):
        ...
        """
        arg = -1
        with self.assertRaises(Exception): co.validate_date(arg)
