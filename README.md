# The Basics
<h2>A project focused on implementing all 32 reserved keywords from C programming in various languages</h2>
<h3>Introduction:</h3>
...
<p>To that end, here's several programs, written in C, Java, Python, and more, that all do the same thing: implement their versions of the reserved keywords from Kerrigan and Ritchie's great book, as well as implement common tasks and features, such as reading command-line arguments or unit testing.</p>
...
<h3>Reference:</h3>
<p>Kernighan, B. W., &amp; Ritchie, D. (1988). A.2.4 Keywords. In C Programming Language (2nd ed.). Upper Saddle River, NJ: Prentice Hall.</p>